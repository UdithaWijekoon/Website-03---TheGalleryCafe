...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: admin_promotions.php?id=$id&message=Promotion updated successfully");
    } else {
        // Redirect with an error message
        header("Location: admin_promotions.php?id=$id&message=Error updating promotion&error=1");
    }
    ...
    header("Location: admin_promotions.php?id=" . $_POST['id']);
    exit();
}
