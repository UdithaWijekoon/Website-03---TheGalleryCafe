...
<style>
/* some styles for delete item page */
body {
...
.item-card .btn-primary:hover {
    ...
    <div class="container mt-5">
        <div class="card shadow-sm p-4">
            <h2 class="mb-4"><i class="fas fa-utensils"></i> Delete Items</h2>

            <!-- This Shaws the delete status -->
            <?php
            ...
            <div class="row" id="items_container">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<a href="delete_item_handler.php?id=' . $row["id"] . '" class="btn btn-danger">Delete</a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
